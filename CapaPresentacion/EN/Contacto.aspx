<%@ Page Title="" Language="C#" MasterPageFile="~/EN/MasterPageEN.Master" AutoEventWireup="true" CodeBehind="Contacto.aspx.cs" Inherits="CapaPresentacion.EN.Contacto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenMain" runat="server">
     <!-- Title Page -->
        <section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(../images/Contacto.jpg);">
            <h2 class="tit6 t-center">Contact us
            </h2>
        </section>
        <!-- Contact form -->
        <section class="section-contact bg1-pattern p-t-90 p-b-113">
            ...
            <div class="container">
                <h3 class="tit7 t-center p-b-62 p-t-105">SEND US A MESSAGE
                </h3>
                ...
                <div class="row p-t-135">
                    <div class="col-sm-8 col-md-4 col-lg-4 m-l-r-auto p-t-30">
                        <div class="dis-flex m-l-23">
                            ...
                            <div class="flex-col-l">
                                <span class="txt5 p-b-10">LOCATION
                                </span>
                    ...
                    <div class="col-sm-8 col-md-3 col-lg-4 m-l-r-auto p-t-30">
                        <div class="dis-flex m-l-23">
                            ...
                            <div class="flex-col-l">
                                <span class="txt5 p-b-10">CALL US
                                </span>
                    ...
                    <div class="col-sm-8 col-md-5 col-lg-4 m-l-r-auto p-t-30">
                        <div class="dis-flex m-l-23">
                            ...
                            <div class="flex-col-l">
                                <span class="txt5 p-b-10">OPENING HOURS
                                </span>
