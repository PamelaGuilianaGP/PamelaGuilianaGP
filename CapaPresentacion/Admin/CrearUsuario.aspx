<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="CrearUsuario.aspx.cs" Inherits="CapaPresentacion.Admin.CrearUsuario" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="text-right">
                                        <div class="col-md-12">
                                            <asp:Button runat="server" ID="BtnGuardar" CssClass="btn btn-success" OnClick="BtnGuardar_Click" ValidationGroup="GroupPrincipal" CausesValidation="true" Text="Crear Usuario" />
